...
.footnote[
This R-Ladies themed xaringan template was kindly developed by [Silvia Canelón](https://silvia.rbind.io/). To use: **usethis::use_course("spcanelon/RLadies-xaringan-template")**
]
